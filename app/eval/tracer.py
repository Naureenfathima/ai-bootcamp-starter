...
"""
eval/tracer.py — Request tracing and LLM observability.
...
class RequestTracer:
    ...
    @contextmanager
    def new_trace(self, name: str, metadata:Optional[ dict] = None):
    ...
    @contextmanager
    def span(self, trace: Trace, name: str, metadata:Optional[ dict] = None):
